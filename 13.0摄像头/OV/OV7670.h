...
#define OV7670_WRST		PDout(14)		//写指针复位
#define OV7670_WREN		PAout(1)		//写入FIFO使能
#define OV7670_RCK		PDout(15)		//读数据时钟
#define OV7670_RRST		PDout(13)  		//读指针复位
#define OV7670_CS		PCout(15)  		//片选信号(OE)
